...
@Component({
    selector: 'asincrono',                 // Nombre de la etiqueta HTML que estamos generando
    templateUrl: './asincrono.component.html',  // La representación gráfica del componente
    styleUrls: ['./asincrono.component.css']    // Estilos propios para este componente
})
export class AsincronoComponent {
